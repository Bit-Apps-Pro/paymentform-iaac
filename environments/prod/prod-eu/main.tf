# Production EU Region - Read Replica
...
locals {
  resource_prefix = "paymentform-prod-eu"
  region          = "eu-west-1"
...
module "aws_compute_backend" {
  ...
  environment                = "prod-eu"
  instance_prefix            = "prod-eu-backend"
  subnet_ids                 = module.aws_networking.public_subnet_ids
  ...
  ecs_cluster_name           = "paymentform-cluster-prod-eu"
  ...
  container_env_vars = {
    ...
    TENANT_TURSO_DEFAULT_REGION = "aws-eu-west-1"
