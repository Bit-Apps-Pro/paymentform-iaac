...
resource "aws_ecs_task_definition" "client" {
  ...
  container_definitions = jsonencode([
    {
      name  = "client"
      image = var.image_registry_type == "ecr" ? "${var.ecr_account_id}.dkr.ecr.${var.ecr_region}.amazonaws.com/paymentform-client:${var.client_version}" : "${var.client_image}:${var.client_version}"
